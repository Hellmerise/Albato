<?php  //[STAMP] 8a68c57c0c934f7d519fd4e541fb5076
// phpcs:ignoreFile
...
trait AcceptanceTesterActions
{
     ...
     *
     *
     * @see \Tests\Support\Helper\GrabHelper::extractFloatFrom()
     */
    public function extractFloatFrom(string $text, bool $safeMode = false): float {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('extractFloatFrom', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Tests\Support\Helper\GrabHelper::extractFloatFrom()
     */
    public function tryToExtractFloatFrom(string $text, bool $safeMode = false): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('extractFloatFrom', func_get_args()));
    }
    /**
     * [!] Method is generated.
     *
     * * Executes extractFloatFrom and retries on failure.
     *
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\GrabHelper::extractFloatFrom()
     */
    public function retryExtractFloatFrom(string $text, bool $safeMode = false) {
        $retryNum      = $this->retryNum ?? 1;
        $retryInterval = $this->retryInterval ?? 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('extractFloatFrom', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     *
     * @return void
     * @see \Tests\Support\Helper\AssertHelper::assertSumEqual()
     */
    public function assertSumEqual(float $expected, array $items, string $key): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('assertSumEqual', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Tests\Support\Helper\AssertHelper::assertSumEqual()
     */
    public function tryToAssertSumEqual(float $expected, array $items, string $key): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('assertSumEqual', func_get_args()));
    }
    /**
     * [!] Method is generated.
     *
     * * Executes assertSumEqual and retries on failure.
     *
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\AssertHelper::assertSumEqual()
     */
    public function retryAssertSumEqual(float $expected, array $items, string $key) {
        $retryNum      = $this->retryNum ?? 1;
        $retryInterval = $this->retryInterval ?? 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('assertSumEqual', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     *
     * @return void
     * @see \Tests\Support\Helper\AssertHelper::assertUniqueValue()
     */
    public function assertUniqueValue(array $array, string $keys = ''): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('assertUniqueValue', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Tests\Support\Helper\AssertHelper::assertUniqueValue()
     */
    public function tryToAssertUniqueValue(array $array, string $keys = ''): bool {
        return $this->getScenario()->runStep(new \Codeception\Step\TryTo('assertUniqueValue', func_get_args()));
    }
    /**
     * [!] Method is generated.
     *
     * * Executes assertUniqueValue and retries on failure.
     *
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\AssertHelper::assertUniqueValue()
     */
    public function retryAssertUniqueValue(array $array, string $keys = '') {
        $retryNum      = $this->retryNum ?? 1;
        $retryInterval = $this->retryInterval ?? 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('assertUniqueValue', func_get_args(), $retryNum, $retryInterval));
    }
